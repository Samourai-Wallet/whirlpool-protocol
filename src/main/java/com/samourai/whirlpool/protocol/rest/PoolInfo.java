...
public class PoolInfo {
    ...
    public PoolInfo(String poolId, long denomination, long minerFeeMin, long minerFeeMax, int minAnonymitySet, int nbRegistered,
                    int mixAnonymitySet, MixStatus mixStatus, long elapsedTime, int mixNbConfirmed) {
        this.poolId = poolId;
